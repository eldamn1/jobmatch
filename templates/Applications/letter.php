...
<head>
    <meta charset="utf-8">
    <title>Offer Letter | JobMatch</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .sheet {
            ...
            padding: 2.4cm 2.4cm; box-shadow: 0 6px 24px rgba(0,0,0,0.18);
        }

        .letterhead { display: flex; align-items: center; gap: 16px; border-bottom: 3px solid #c9a227; padding-bottom: 16px; margin-bottom: 6px; }
        ...
        @media print {
            ...
            .sheet { box-shadow: none; margin: 0; width: 100%; min-height: auto; padding: 2cm 2.2cm; }
        }
    </style>
</head>
<body>
...
<div class="sheet">
    ...
    <div class="letter-body"><?= h($application->offer_letter) ?></div>
</div>
